...
<svelte:head>
	<title>Eazy Tech Writers & Solutions</title>
	<meta name="description" content="EazyTechWriters&Solutions" />
</svelte:head>
<div class="app">
	<!-- Hero section -->
	<header class="hero-section text-dark bg-image"
		...
		<div class="container d-flex justify-content-center align-items-center h-100">
			<div class="text-center">
				<h1 class="display-1 fw-bold">Welcome to Eazy Tech Writers & Solutions</h1>
				<p class="fs-3">Your one-stop shop for writing and business solutions.</p>
			</div>
		</div>
	</header>
				...
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-10 col-lg-8">
							<h1 class="fs-5 mb-2 text-uppercase">Contact Us</h1>
							<p class="mb-4 mb-md-5 mb-xl-8">We're always on the lookout to work with new clients. Please get in touch in one of the following ways.</p>
						</div>
					</div>
				</div>
										...
										<div class="col-12 col-sm-6">
											<div class="mb-4 mb-sm-0">
												...
												<div>
													...
													<p class="mb-0">
														<a class="link-primary text-decoration-none" href="tel:+254712345678">(254) 712345678</a>
													</p>
												</div>
											</div>
										</div>
										<div class="col-12 col-sm-6">
											<div class="mb-4 mb-sm-0">
												...
												<div>
													...
													<hr class="w-75 mb-3 border-dark-subtle">
													<p class="mb-0">
														<a class="link-primary text-decoration-none" href="mailto:demo@yourdomain.com">demo@yourdomain.com</a>
													</p>
												</div>
											</div>
										</div>
									...
									<div>
										...
										<div>
											...
											<div class="d-flex mb-1">
												<p class="text-primary fw-bold mb-0 me-5">Sun - Sat</p>
												<p class="text-primary mb-0">24/7</p>
											</div>
<!--											<div class="d-flex">-->
<!--												<p class="text-primary fw-bold mb-0 me-5">Sat - Sun</p>-->
<!--												<p class="text-primary mb-0">9am - 2pm</p>-->
<!--											</div>-->
										</div>
									</div>
								</div>
